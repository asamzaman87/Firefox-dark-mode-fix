...
<h5>
Fix this is a Chrome Extension that simplifies reading long documents with GPT.
<br />
...
This is a minimal quick start for using Fix this with Chrome and Firefox in dev mode.
