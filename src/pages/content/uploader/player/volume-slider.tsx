  ...
  return (
    <Popover modal>
      <PopoverTrigger asChild>
        <Button variant="ghost" disabled={disabled} size={"icon"} className="gpt:hover:scale-115 gpt:active:scale-105 gpt:transition-all gpt:rounded-full gpt:border gpt:border-gray-200 gpt:dark:border-gray-700 gpt:bg-gray-50 gpt:dark:bg-gray-800">
