          ...
          <div className="gpt:flex gpt:flex-col gpt:gap-5">
            {options.map((option, index) => (
              <div
                ...
                key={index}
                className={cn(
                  "group gpt:relative gpt:grid gpt:size-full gpt:cursor-pointer gpt:place-items-center gpt:rounded-2xl gpt:border-2 gpt:border-dashed gpt:border-gray-500 gpt:dark:hover:border-gray-200 hover:border-gray-700 gpt:p-5 gpt:text-center gpt:transition gpt:hover:bg-gray-200 gpt:dark:hover:bg-gray-700",
