...
export const TICKS_TO_DISPLAY = [0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4];
export const MODELS_TO_WARN = ["o1", "o2", "o3", "o4", "o5", "o6", "o7"];
export const CHUNK_TO_PAUSE_ON = 21; //end of chunk
...
export const FREE_DOWNLOAD_CHUNKS = 4;
...
export const LIFETIME_DEAL_ID = "price_1SdiYiLARZb1bIqHI1JRmyie"; // 99.99 one time fee
export const LIFETIME_PRICE = "$99.99";
export const SUBSCRIBER_ANNUAL_NUDGE_FREQUENCY = 10;
export const IMPORTANT_COOLDOWN_MS = 30 * 60 * 1000;
export const SAFEST_MODEL = "gpt-5-1-instant";
