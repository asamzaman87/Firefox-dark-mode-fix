...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "gpt:flex gpt:flex-col gpt:space-y-1.5 gpt:text-center gpt:sm:gpt:text-left",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "gpt:flex gpt:flex-col-reverse gpt:sm:gpt:flex-row gpt:sm:gpt:justify-end gpt:sm:gpt:space-x-2",
      className
    )}
    {...props}
  />
