...
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "gpt:z-50 gpt:w-72 gpt:rounded-md gpt:border gpt:bg-popover gpt:p-4 gpt:text-popover-foreground gpt:shadow-md gpt:outline-none data-[state=open]:gpt:animate-in data-[state=closed]:gpt:animate-out data-[state=closed]:gpt:fade-out-0 data-[state=open]:gpt:fade-in-0 data-[state=closed]:gpt:zoom-out-95 data-[state=open]:gpt:zoom-in-95 data-[side=bottom]:gpt:slide-in-from-top-2 data-[side=left]:gpt:slide-in-from-right-2 data-[side=right]:gpt:slide-in-from-left-2 data-[side=top]:gpt:slide-in-from-bottom-2",
        className
      )}
      {...props}
    />
